...
urlpatterns = [
    ...
    path('admin_approval_contractor/' , views.admin_approval_contractor),
    path('admin_approval_user/' , views.admin_approval_user,name="admin_approval_user"),
    path('admin_reject_contractor/' , views.admin_reject_contractor),
